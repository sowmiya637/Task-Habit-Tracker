...
if (localStorage.getItem("theme") === "dark") {
  ...
  themeIcon.src = "../asset/sun.png"; 
} else {
  themeIcon.src = "../asset/moon.png"; 
}
...
function renderFilteredHabits(filteredHabits) {
  ...
  <button class="mark-btn">Mark complete</button>
    ...
    // Attach click listener to all day-boxes inside this habit card
habitCard.querySelectorAll(".day-box").forEach(box => {
...
function renderHabits() {
  ...
  box.addEventListener("click", () => {
    ...
    console.log("apply completetion habit", habit)
