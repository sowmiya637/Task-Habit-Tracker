...
if (localStorage.getItem("theme") === "dark") {
  ...
  themeIcon.src = "../asset/sun.png"; // show sun icon for dark mode
} else {
  themeIcon.src = "../asset/moon.png"; // show moon icon for light mode
}
...
themeToggle.addEventListener("click", () => {
  ...
  themeIcon.src = isDark ? "../asset/sun.png" : "../asset/moon.png";
...
// renderTasks(tasks
  ...
  <div class="task-top" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
    ...
    <div class="task-actions-icons" style="display: flex; gap: 10px;">
      <i class="fa-solid fa-chevron-up move-up" title="Move Up" style="cursor: pointer; color: #25314C;"></i>
      <i class="fa-solid fa-chevron-down move-down" title="Move Down" style="cursor: pointer; color: #25314C;"></i>
...
<p style="margin: 5px 0; text-align:left; font-size: 14px; display: flex; align-items: center; gap: 10px;">
  ...
  <!-- Priority -->
  <!-- <span style="display: inline-flex; align-items: center; gap: 6px; border-radius: 10px; background-color: ${task.priority === 'High' ? '#D4183D' : task.priority === 'Medium' ? '#D78905' : '#3B82F6'}; color: white; font-size: 12px; padding: 4px 10px;">
  ...
  <!-- Date -->
<span class="date-box">
  <img src="../asset/calender.png" alt="calendar" class="date-icon">
  <span class="date-text">${formatDate(task.date)}</span>
</span>
    ...
    <div class="subtask-content" style="display: none;">
      <div class="subtask-input"
        ...
        <button class="add-subtask-btn"
                style="background-color: #54BD95; border: none; color: white; width: 35px; height: 35px; border-radius: 6px; cursor: pointer; transition: 0.2s;">
...
addBtn.addEventListener("click", () => {
  ...
  <div style="display: flex; align-items: center; gap: 8px;">
     <img src="../asset/edit.png" alt="Edit" title="Edit" class="edit-subtask" style="cursor: pointer; width: 16px; height: 16px;">
     <img src="../asset/delete.png" alt="Delete" title="Delete" class="delete-subtask" style="cursor: pointer; width: 16px; height: 16px;">
  </div>
`;
  ...
  checkbox.addEventListener("change", () => {
    if (checkbox.checked) {
      ...
      span.style.color = "#6b7280"; // optional grey
    } else {
      span.style.textDecoration = "none";
      span.style.color = "#374151"; // reset color
    }
  });
  ...
  //  Edit subtask
  li.querySelector(".edit-subtask").addEventListener("click", () => {
